...
inter_y = Function('inter', [c0_f, m0_f], [(c0_f*ms[1:] - cs[1:]*m0_f) / (ms[1:] - m0_f)])

get_nx = Function('nx', [n_f, th_f], [inter_x(get_c(tan(th_f), o_x_s(n_f), o_y_s(n_f)), tan(th_f))])
get_ny = Function('ny', [n_f, th_f], [inter_y(get_c(tan(th_f), o_x_s(n_f), o_y_s(n_f)), tan(th_f))])
